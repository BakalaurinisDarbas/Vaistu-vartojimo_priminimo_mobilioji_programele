...
import 'package:medicine/screens/navbar.dart';
...
void main() {
  ...
  SystemChrome.setSystemUIOverlayStyle(
    SystemUiOverlayStyle(
      ...
      systemNavigationBarDividerColor: Colors.white54,
...
class MedicineApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        fontFamily: "Popins",
        primaryColor: Color.fromRGBO(250, 170, 33, 1.0),
